        ...
        <div className="flex items-center justify-between p-6 border-b border-(--card-border) shrink-0">
          <div>
            ...
            <p className="text-sm text-(--text-muted) mt-1">
              Import a Git repository or upload project files directly.
            </p>
          </div>
          <button
            onClick={onClose}
                  ...
                  {fakeRepos.map((repo, i) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        {repo.private && (
                          <span className="px-2 py-0.5 text-[10px] uppercase tracking-wider font-semibold bg-(--card-bg) border border-(--card-border) text-(--text-muted) rounded-md">
                            Private
                          </span>
                        )}
                      </div>
